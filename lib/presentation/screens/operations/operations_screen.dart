  ...
  final List<Map<String, dynamic>> _operations = [
    {
      ...
      'updates': [
        ...
        {'date': DateTime(2024, 11, 20), 'message': 'Yeni bölgeye geçildi'},
      ],
      'priority': 'high',
    },
    {
    ...
    },
    {
      ...
      'updates': [
        {'date': DateTime(2024, 10, 15), 'message': 'İlk müdahale yapıldı'},
        {
          ...
          'message': 'Yaralılar hastaneye sevk edildi',
        }
      ],
      'priority': 'medium',
    },
      ...
      'updates': [
        {
          ...
          'message': 'Tahliye çalışmaları başladı',
        },
        {
          'date': DateTime(2024, 11, 12),
          'message': '50 aileye yardım ulaştırıldı',
        }
      ],
      'priority': 'high',
    },
  ...
  Widget _buildTypeFilter() {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: _operationTypes.length,
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: _buildDetailItem(
                  ...
                  DateFormat('dd.MM.yyyy').format(operation['startDate']),
                ),
              ),
            ],
          ),
          ...
          if (operation['updates'] != null &&
            ...
            const SizedBox(height: 8),
            ...operation['updates'].take(2).map<Widget>((update) {
              return Padding(
          ...
          SizedBox(
            ...
            child: OutlinedButton(
              onPressed: () => _showOperationDetails(operation),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (operation['updates'] != null &&
                        ...
                        const SizedBox(height: 12),
                        ...operation['updates'].map<Widget>((update) {
                          return Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  DateFormat('dd.MM').format(update['date']),
                                  style: const TextStyle(
                                    color: Color(0xFF64748B),
                                    fontSize: 12,
                                    fontWeight: FontWeight.w600,
