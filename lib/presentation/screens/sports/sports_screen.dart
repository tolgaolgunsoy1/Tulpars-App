  ...
  final List<Map<String, dynamic>> _sportsActivities = [
    {
      ...
      'color': const Color(0xFFF59E0B)'schedule': 'Salı-Perşembe 19:00-21:00',
      ...
      'color': const Color(0xFF10B981)'schedule': 'Cumartesi-Pazar 10:00-12:00',
      ...
      'color': const Color(0xFF8B5CF6)'schedule': 'Çarşamba-Cuma 18:00-20:00',
      'location': 'Tulpars Spor Salonu',
      'participants': 18,
      'coach': 'Ayşe Antrenör',
      ...
      'icon': Icons.terrain,
      'color': const Color(0xFF06B6D4)'schedule': 'Pazar 09:00-16:00',
      'location': 'Saklıkent Kanyonu',
      'participants': 45,
      'coach': 'Doğa Lideri Hasan',
      'upcoming': '30 Aralık - Kış Kampı',},];final List<Map<String, dynamic>> _achievements = [
    {
      ...
      'color': const Color(0xFF8B5CF6)},];@override
        ...
        child: SingleChildScrollView(
          padding: const EdgeInsets.all(24) child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 32)// Sports Activities
              _buildSportsActivities(),

              const SizedBox(height: 32)// Achievements
              _buildAchievements(),

              const SizedBox(height: 32)// Join Section
              _buildJoinSection(),],),),),);}
      ...
      children: [
        const Text(
          ...
          style: TextStyle(
            fontSize: 18,
            fontWeight: FontWeight.bold,
            color: Color(0xFF0F172A)),),const SizedBox(height: 16)..._sportsActivities.map(_buildActivityCard)],);}
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: activity['color'].withValues(alpha: 0.1) borderRadius: BorderRadius.circular(12)), child: Icon(
                  activity['icon'],
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: const TextStyle(
                        fontSize: 12,
                        color: Color(0xFF64748B)),),],),),],),const SizedBox(height: 16)// Details
          Row(
            children: [
              _buildDetailItem(Icons.schedule, activity['schedule']),
              const SizedBox(width: 16)_buildDetailItem(Icons.location_on, activity['location']),],),const SizedBox(height: 12)Row(
            children: [
              _buildDetailItem(
                  Icons.people, '${activity['participants']} Katılımcı',),
              const SizedBox(width: 16)_buildDetailItem(Icons.person, activity['coach']),],),const SizedBox(height: 16)// Upcoming Event
          Container(
                ...
                const Icon(
                  ...
                  child: Text(
                    ...
                    style: const TextStyle(
                      ...
                      color: Color(AppConstants.accentColor)),),),],),),const SizedBox(height: 16)// Join Button
          SizedBox(
            ...
            child: OutlinedButton(
              ...
              style: OutlinedButton.styleFrom(
                side: BorderSide(color: activity['color']), shape: RoundedRectangleBorder(
        ...
        children: [
          Icon(
            ...
            child: Text(
              ...
              style: const TextStyle(
                fontSize: 12,
                color: Color(0xFF64748B)), overflow: TextOverflow.ellipsis,),),],),);}
            ...
            children: _achievements.map((achievement) {
              return Container(
                margin: const EdgeInsets.only(bottom: 16) padding: const EdgeInsets.all(16) decoration: BoxDecoration(
                  color: achievement['color'].withValues(alpha: 0.1) borderRadius: BorderRadius.circular(12) border: Border.all(
                    color: achievement['color'].withValues(alpha: 0.2)),), child: Row(
                  children: [
                    Icon(
                      achievement['icon'],
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                              color: achievement['color'],),),const SizedBox(height: 4)Text(
          ...
          const Icon(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                foregroundColor: const Color(AppConstants.successColor) shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(12)), elevation: 0,), child: const Text(
                'Üye Ol',
                style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w600,),),),),],),);}
      ...
      builder: (context) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)), title: Text(
          ...
          TextButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: activity['color'],), child: const Text('Katıl'),),],),);}
